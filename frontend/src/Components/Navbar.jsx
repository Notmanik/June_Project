...
const Navbar = () => {
  ...
  return token ? (
    <div className={`bg-gradient-to-r from-indigo-600 to-purple-700 shadow-lg transition-all duration-300 sticky top-0 z-50 ${
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center group cursor-pointer">
              ...
              <span className="ml-3 text-white text-xl font-bold tracking-wide">Vistara</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center">
            <div className="ml-3 relative" ref={dropdownRef}>
              ...
              >
                <div className="bg-gradient-to-br from-indigo-200 to-purple-200 border-2 border-white/50 rounded-full w-10 h-10 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow duration-200">
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="flex items-center">
                      <div className="bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full w-10 h-10 flex items-center justify-center text-white font-bold">
                        {username?.charAt(0).toUpperCase() || 'U'}
                      </div>
                      <div className="ml-3">
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div>
                    <div>Create Post</div>
                    <div className="text-xs text-indigo-300">Share your thoughts</div>
                  </div>
                </div>
              </Link>
    ...
    <nav className={`bg-gradient-to-r from-indigo-600 to-purple-700 shadow-lg transition-all duration-300 sticky top-0 z-50 ${
      isScrolled ? 'shadow-xl backdrop-blur-sm bg-opacity-95' : ''
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
