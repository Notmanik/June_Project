      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl shadow-xl overflow-hidden mb-8">
          <div className="p-6 md:p-8 flex flex-col md:flex-row items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-indigo-100 text-xl mb-4">@{userData.username}</p>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3 mb-6">
                ...
                <div className="bg-indigo-600 bg-opacity-30 backdrop-blur-sm px-4 py-2 rounded-full flex items-center">
                  ...
                  <span className="text-white">{userData.friends.length} friends</span>
                </div>
        ...
        <div className="bg-white rounded-xl shadow-lg mb-8 overflow-hidden">
          ...
          <div className="p-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-800 font-medium">{userData.mobileNumber}</p>
                      </div>
                    </div>
            ...
            {activeTab === 'interests' && (
              <div>
                <h3 className="text-lg font-bold text-gray-800 mb-6">Your Interests</h3>
                ...
                {userData.interests.length > 0 ? (
                  <div className="flex flex-wrap gap-3">
                    {userData.interests.map((interest, index) => (
                      ...
                      >
                        <span className="text-indigo-700 font-medium">{interest}</span>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-xl font-medium text-gray-800 mb-2">No interests added</h3>
                    <p className="text-gray-600 mb-6">Add interests to personalize your experience</p>
                    <button 
                      className="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition-all"
                      onClick={() => navigate('/home/profile/edit')}
                    >
                ...
                <div className="mt-8">
                  <h3 className="text-lg font-bold text-gray-800 mb-4">Suggested Interests</h3>
                  <div className="flex flex-wrap gap-3">
                    {['Photography', 'Travel', 'Food', 'Technology', 'Art', 'Music', 'Fitness', 'Reading', 'Gaming', 'Nature'].map((interest, index) => (
                      <button 
                        key={index}
